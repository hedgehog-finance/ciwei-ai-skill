...
## Usage
```bash
node ${HERMES_SKILL_DIR}/scripts/call-api.mjs <method> '<params-json>'
node ${HERMES_SKILL_DIR}/scripts/call-api.mjs <method> --params-file <params.json>
```
...
node ${HERMES_SKILL_DIR}/scripts/call-api.mjs npv '{"rate":0.1,"cashFlows":[3000,4000,5000]}'
node ${HERMES_SKILL_DIR}/scripts/call-api.mjs remaining-loan-term '{"startDateStr":"01 2020","loanTerm":30,"loanTermUnit":"Years"}'
```
