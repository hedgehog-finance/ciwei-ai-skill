...
The portable spelling is `apiKey`; managed HogAgent installations may use the `api-key` alias. The loader accepts both without changing precedence for the canonical field.
