...
/** Get HogAgent config dir (system-dir name is canonical; user-dir is accepted for managed HogAgent). */
function getSystemDir() {
  return process.env.HOGAGENT_SYSTEM_DIR
    || process.env.HOGAGENT_USER_DIR
...
export function loadConfig() {
  ...
  const apiKey = entry.apiKey || entry['api-key'] || process.env.DOC_CONVERT_API_KEY || "";
